...
static void mavlink_test_systemid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_systemid_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_systemid_pack(system_id, component_id, &msg , packet1.u_a , packet1.u_e , packet1.u_r , packet1.ax , packet1.ay , packet1.az , packet1.p , packet1.q , packet1.r );
	mavlink_msg_systemid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_systemid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.u_a , packet1.u_e , packet1.u_r , packet1.ax , packet1.ay , packet1.az , packet1.p , packet1.q , packet1.r );
	mavlink_msg_systemid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_systemid_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_systemid_send(MAVLINK_COMM_1 , packet1.u_a , packet1.u_e , packet1.u_r , packet1.ax , packet1.ay , packet1.az , packet1.p , packet1.q , packet1.r );
	mavlink_msg_systemid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
